LOCALHOME=/Software/users/lofarsoft/software_norma3/local/
PATH=$PATH:/usr/local/karma/bin:$LOCALHOME/bin:$LOCALHOME/casacore/bin
LD_LIBRARY_PATH=/opt/intel/mic/filesystem/base/lib64/:$LD_LIBRARY_PATH:$LOCALHOME/lib:$LOCALHOME/casacore/lib64:$LOCALHOME/pyrap/lib64:
