...
if(CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
  ...
  if(NOT GFORTRAN_LIB_DIR_STR)
    ...
    string(REGEX REPLACE "--libdir=([^\t\n ]+)" "\\1"
      GFORTRAN_LIBRARIES_DIR1 "${GFORTRAN_LIB_DIR_STR}")
    string(CONCAT GFORTRAN_LIBRARIES_DIR "${GFORTRAN_LIBRARIES_DIR1}" "/gcc/" "${GFORTRAN_ARCH}" "/" "${GFORTRAN_VERSION_STRING}")
    string(CONCAT GFORTRAN_INCLUDE_DIR "${GFORTRAN_LIBRARIES_DIR1}" "/gcc/" "${GFORTRAN_ARCH}" "/" "${GFORTRAN_VERSION_STRING}" "/include")
  endif()
  ...
  find_library(LIBGFORTRAN_LIBRARIES NAMES gfortran libgfortran
    PATHS ${GFORTRAN_LIBRARIES_DIR}
    PATH_SUFFIXES ${GFORTRAN_VERSION_STRING})
...
message(STATUS ${LIBGFORTRAN_LIBRARIES})
message(STATUS ${GFORTRAN_LIBRARIES_DIR})
message(STATUS ${GFORTRAN_VERSION_STRING})
